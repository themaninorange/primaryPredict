...
\begin{figure}[h!]
\subfloat[][]{\includegraphics[scale=.38]{images/newwordclouddem}\label{Keyword ``Democrat}}
\hspace{1mm}
\subfloat[][]{\includegraphics[scale = .4]{images/newwordcloudrep}\label{Keyword ``Republican}}
...
\begin{itemize}
	...
	\hline
	\onslide<2->{
		My Tweet} & \onslide<2->{5} & \onslide<2->{0} & \onslide<2->{\dots} & \onslide<2->{0} \\
	\hline
	\end{tabular}}
	\end{table} \pause 
...
\begin{frame}
\frametitle{Results \hfill \includegraphics[scale=.12]{images/democraticlogo2.png}}
\section{Results}
